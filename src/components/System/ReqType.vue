    ...
    <div id="index">
        <div class="breadcrumb">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item><span class="color-blue">任务类型</span></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            <el-row>
                <el-col :span="24">
                    <el-row class="margin-top20 padding-left20 padding-right20">
                        <el-col :span="4">
                            <div class="el-button-copy" @click="add">新增类型</div>
                        </el-col>
                ...
                <el-col :span="24" class="table padding-left20 padding-right20 margin-top5">
                    <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="taskName" label="类型名称"></el-table-column>
        ...
        <!-- 新增模板 -->
        <el-dialog title="新增类型" :visible.sync="dialogVisible" width="500px" :before-close="handleClose">
            <el-form ref="form" :model="form" label-width="120px">
                <el-form-item label="类型名称：">
                    <el-input v-model="form.taskName" placeholder="请输入类型名称" class="width300"></el-input>
                </el-form-item>
            </el-form>
        ...
        <el-dialog title="修改类型：" :visible.sync="dialogEditVisible" width="500px" :before-close="handleClose">
            <el-form ref="forms" :model="form" label-width="120px">
                <el-form-item label="分类名称：">
                    <el-input v-model="forms.taskName" placeholder="请输入类型名称" class="width300"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer text-center">
    ...
    export default{
        ...
        methods:{
            ...
            handleClickEdit(row) {
                ...
                this.$api.list.getTypeInfo(params).then(res=> {
                    console.log(res);
                    if(res.data.status == 200){
                        this.forms = res.data.data.taskType;
            ...
            //删除回调
            callbackit(index){
                let params ={taskId : this.typeId}
                this.$api.list.deleteType(params).then(res=> {
                    if(res.data.status == 200){
            ...
            handleClickDelete(row) {
                this.typeId = row.taskId;
                this.utils.open("删除","是否确认删除"+row.taskName,"warning",this.callbackit,"删除");
            },
            //新增、编辑、查看弹窗关闭
            handleClose(done) {
                this.$confirm('确认关闭？')
            ...
            addBack(data){
                ...
                this.$api.list.insertType(params).then(res=> {
                    if(res.data.status == 200){
            ...
            editBack(data){
                ...
                params.submitToken = data;
                this.$api.list.editType(params).then(res=> {
                    if(res.data.status == 200){
            ...
            typeAction(){
                ...
                this.$api.list.getTypeList(params).then(res=> {
                    console.log(res);
                    if(res.data.status == 200){
