    ...
    <div id="index">
        <div class="breadcrumb">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item><span class="color-blue">区域财务</span></el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        
        <section class="admin-table">
            <div class="top_area_finance text-center">
                <h3 class="padding-top10 color-white">区域总收入</h3>
                <h2 class="padding-top10 color-white">{{balance}}</h2>
            </div>
            <el-row>
    ...
    export default{
        ...
        methods:{
            ...
            taskAction(){
                ...
                this.$api.list.distList(page,size).then(res=> {
                    console.log(res);
