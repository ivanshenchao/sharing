<template>
    <div id="information">
        <div class="information">
            ...
            <div class="margin-bottom20" style="margin-top:40px">
        ...
        data(){
            return{
                ...
                editorOption: {
                    ...
                    syntax: true,
                    action:  this.url,  // 必填参数 图片上传地址
                    methods: 'post',  // 必填参数 图片上传方式
                    token: this.token,  // 可选参数 如果需要token验证，假设你的token有存放在sessionStorage
    ...
    quillEditor
        ...
        methods:{
            ...
            responseAction(response){
                ...
                this.imageUrl = base+'/'+response.data.fileUrl;
                this.showFile = false;
            ...
            responseActions(response){
                console.log(response);
                this.imageUrls = base+'/'+response.data.fileUrl;
            ...
            if(this.aid != 0 ){
                ...
                this.$api.list.getColumnContentInfo(params).then(res=> {
                    ...
                    if(res.data.status == 200){
                        ...
                        this.imageUrl = base+this.form.fileUrl;
                    }else{
                        this.$message.error(res.data.msg);
                    }
                }).catch(error=>{
